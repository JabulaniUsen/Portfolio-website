...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Usenobong &mdash; Front-end & App Developer</title>
        <meta name="description" content="The portfolio of USENOBONG ETOKAKPAN" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name='description' content='USENOBONG ETOKAKPAN is a frontend developer passionate about building websites 
      ...
      <div className='pt-32 px-8 md:pt-80 lg:pt-16 h-[700px] bg-light-dark md:h-screen'>
        ...
        <p className={`text-shadow hero-text font-bold lg:text-[120px] text-primary tracking-wider`}>Etokakpan</p>
        <div className='lg:pl-8'>
         <p 
          ...
          JavaScript, Reactjs/Next.js, React Native, Redux/Redux-toolkit, Tailwind, Git, Github...
         </p>
        </div>
        </motion.div>
        </div>
