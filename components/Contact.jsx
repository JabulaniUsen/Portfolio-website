...
export default function Contact() {
    ...
    const handleCopy = () => {  
        ...
        copy('jabulanietokakpan@gmail.com', {
        ...
        <section className='text-secondary md:py-0 px-8'>
           <div className="flex justify-center">
            ...
            hover:text-black text-center uppercase">
                <a 
                href="mailto:jabulanietokakpan@gmail.com?subject=Hello Usenobong,...">       
                   Get in Touch  
                </a> 
            </p>
        <motion.footer 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
                <a href="mailto:jabulanietokakpan@gmail.com?subject=Hello Usenobong,...">
                <HiMail/>
                </a>
            </li>  

            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
                <a href='https://linkedin.com/in/usenobong%20etokakpan' 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://github.com/JabulaniUsen' 
            target='_blank' rel='noopener noreferrer'>
                <AiFillGithub/>
            </a>
            </li>
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://x.com/jabulaniusen' 
            target='_blank' rel='noopener noreferrer'>
                <AiOutlineTwitter/>
            </a>
            </li> 
            ...
            <p className="text-secondary my-4 text-center">
                &copy; {new Date().getFullYear()} Usenobong Usen. All Rights Reserved
            </p>
            </div>
        </motion.footer>
        </section>
